  ...
  try {
    ...
    rows = result.items.map((item) => ({
      ...
      defaultValues: {
        ...
        image: item.image ?? "",
        review: item.review,
        ratingQuality: item.ratings?.quality ?? Math.round(item.rating),
        ratingCommunication: item.ratings?.communication ?? Math.round(item.rating),
        ratingValueForMoney: item.ratings?.valueForMoney ?? Math.round(item.rating),
